      ...
      <div className="mx-auto grid max-w-6xl gap-8 px-4 py-10 md:grid-cols-4 md:px-6">
        <div className="md:col-span-2">
          <Link href="/" className="inline-flex items-center gap-2" aria-label="Thaaza home">
            <span className="flex h-9 w-9 items-center justify-center rounded-[10px] bg-burgundy text-sm font-bold text-cream">Tz</span>
            <span>
          ...
          <p className="mt-3 text-sm text-gold">{BRAND.telugu}</p>
        </div>
        <div>
