...
export const products: Product[] = [
  ...
  {
    id: "broiler-curry",
    slug: "broiler-chicken-curry-cut",
    name: "Broiler Chicken — Curry Cut",
    categoryId: "chicken",
    cut: "Curry cut",
    description:
      "Broiler chicken curry cut with skin as preferred. Daily fresh stock.",
    priceKey: "broilerCurryPerKg",
    unit: "kg",
    minQty: 0.5,
    step: 0.25,
  ...
  {
    id: "broiler-biryani",
    slug: "broiler-chicken-biryani-cut",
    name: "Broiler Chicken — Biryani Cut",
    categoryId: "chicken",
    cut: "Biryani cut",
    description: "Broiler chicken cut for biryani pots — bone-in pieces sized for dum.",
    priceKey: "broilerBiryaniPerKg",
    unit: "kg",
    minQty: 0.5,
    step: 0.25,
  ...
  {
    id: "broiler-boneless",
    slug: "broiler-chicken-boneless",
    name: "Broiler Chicken — Boneless",
    categoryId: "chicken",
    cut: "Boneless",
    description: "Boneless broiler chicken for grill, curry or meal prep.",
    priceKey: "broilerBonelessPerKg",
    unit: "kg",
    minQty: 0.25,
    step: 0.25,
  ...
  {
    id: "broiler-breast",
    slug: "broiler-chicken-breasts",
    name: "Broiler Chicken — Breasts",
    categoryId: "chicken",
    cut: "Breasts",
    description: "Chicken breast pieces — lean and ready for grill or gravy.",
    priceKey: "broilerBreastPerKg",
    unit: "kg",
    minQty: 0.25,
    step: 0.25,
  ...
  {
    id: "broiler-leg",
    slug: "broiler-chicken-leg-pieces",
    name: "Broiler Chicken — Leg Pieces",
    categoryId: "chicken",
    cut: "Leg Pieces",
    description: "Bone-in leg pieces for fry, curry or roast.",
    priceKey: "broilerLegPerKg",
    unit: "kg",
    minQty: 0.5,
    step: 0.25,
